...
public class TriviaActivity extends AppCompatActivity implements GetImageAsyncTask.IData
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            this.questions = (ArrayList<Question>) getIntent().getExtras().getSerializable(MainActivity.QUESTIONS_KEY);
    ...
    private void showStats()
    {
        ...
        statsIntent.putExtra(MainActivity.QUESTIONS_KEY, questions);
